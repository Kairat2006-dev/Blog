...
{{--                READ-All --}}
                    ...
                    <div class="card-body table-responsive p-0">
                        <table class="table table-hover text-nowrap">
                            ...
                            <tr>
                                <td>{{$tag->id}}</td>
                                <td><ya-tr-span data-index="70-0" data-translated="true" data-source-lang="en" data-target-lang="ru" data-value="Mike Doe" data-translation="Майк Доу" data-ch="0" data-type="trSpan" style="visibility: initial !important;">{{$tag->title}}</ya-tr-span></td>
                                <td>{{$tag->created_at}}</td>
                                <td><a href="{{route('tags.show',$tag->id)}}"><i class="fa-solid fa-eye"></i></a></td>
                                <td><a href="{{route('tags.edit',$tag->id)}}"><i class="fa-solid fa-file-lines"></i></a></td><td>
