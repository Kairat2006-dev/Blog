...
(function (global, factory) {
  ...
  var SELECTOR_CONTROL_SIDEBAR = '.control-sidebar.blade.php';
  var SELECTOR_CONTROL_SIDEBAR_CONTENT$1 = '.control-sidebar.blade.php-content';
  var SELECTOR_DATA_TOGGLE$4 = '[data-widget="control-sidebar.blade.php"]';
  var SELECTOR_HEADER$1 = '.main-header';
  var SELECTOR_FOOTER$1 = '.main-footer';
  var CLASS_NAME_CONTROL_SIDEBAR_ANIMATE = 'control-sidebar.blade.php-animate';
  var CLASS_NAME_CONTROL_SIDEBAR_OPEN$1 = 'control-sidebar.blade.php-open';
  var CLASS_NAME_CONTROL_SIDEBAR_SLIDE = 'control-sidebar.blade.php-slide-open';
  ...
  var ControlSidebar = /*#__PURE__*/function () {
    ...
    _proto.collapse = function collapse() {
      ...
      var $html = $__default["default"]('html'); // Show the control sidebar.blade.php
    ...
    _proto.show = function show(toggle) {
      ...
      if (toggle) {
        $__default["default"](SELECTOR_CONTROL_SIDEBAR).hide();
      } // Collapse the control sidebar.blade.php
    ...
    _proto.toggle = function toggle() {
      ...
      if (notVisible || shouldToggle) {
        // Open the control sidebar.blade.php
        this.show(notVisible);
      } else if (shouldClose) {
        // Close the control sidebar.blade.php
        this.collapse();
      }
    } // Private
    ;
  ...
  var SELECTOR_SIDEBAR_MENU_ITEM = '.main-sidebar.blade.php .nav-item > a.nav-link';
  var SELECTOR_SIDEBAR_SEARCH_ITEM = '.sidebar.blade.php-search-results .list-group-item';
  ...
  var SELECTOR_MAIN_SIDEBAR = '.main-sidebar.blade.php';
  var SELECTOR_SIDEBAR$1 = '.main-sidebar.blade.php .sidebar.blade.php';
  var SELECTOR_CONTENT = '.content-wrapper';
  var SELECTOR_CONTROL_SIDEBAR_CONTENT = '.control-sidebar.blade.php-content';
  var SELECTOR_CONTROL_SIDEBAR_BTN = '[data-widget="control-sidebar.blade.php"]';
  var SELECTOR_FOOTER = '.main-footer';
  var SELECTOR_PUSHMENU_BTN = '[data-widget="pushmenu"]';
  var SELECTOR_LOGIN_BOX = '.login-box';
  var SELECTOR_REGISTER_BOX = '.register-box';
  var SELECTOR_PRELOADER = '.preloader';
  var CLASS_NAME_SIDEBAR_COLLAPSED$1 = 'sidebar.blade.php-collapse';
  var CLASS_NAME_SIDEBAR_FOCUSED = 'sidebar.blade.php-focused';
  var CLASS_NAME_LAYOUT_FIXED = 'layout-fixed';
  var CLASS_NAME_CONTROL_SIDEBAR_SLIDE_OPEN = 'control-sidebar.blade.php-slide-open';
  var CLASS_NAME_CONTROL_SIDEBAR_OPEN = 'control-sidebar.blade.php-open';
  ...
  var SELECTOR_OVERLAY = '#sidebar.blade.php-overlay';
  var SELECTOR_WRAPPER = '.wrapper';
  var CLASS_NAME_COLLAPSED = 'sidebar.blade.php-collapse';
  var CLASS_NAME_OPEN$3 = 'sidebar.blade.php-open';
  var CLASS_NAME_IS_OPENING$1 = 'sidebar.blade.php-is-opening';
  var CLASS_NAME_CLOSED = 'sidebar.blade.php-closed';
  var Default$5 = {
  ...
  var DATA_KEY$4 = 'lte.sidebar.blade.php-search';
  var JQUERY_NO_CONFLICT$4 = $__default["default"].fn[NAME$4];
  var CLASS_NAME_OPEN$2 = 'sidebar.blade.php-search-open';
  var CLASS_NAME_ICON_SEARCH = 'fa-search';
  var CLASS_NAME_ICON_CLOSE = 'fa-times';
  var CLASS_NAME_HEADER = 'nav-header';
  var CLASS_NAME_SEARCH_RESULTS = 'sidebar.blade.php-search-results';
  var CLASS_NAME_LIST_GROUP = 'list-group';
  var SELECTOR_DATA_WIDGET$1 = '[data-widget="sidebar.blade.php-search"]';
  var SELECTOR_SIDEBAR = '.main-sidebar.blade.php .nav-sidebar.blade.php';
  ...
  var CLASS_NAME_SIDEBAR_COLLAPSED = 'sidebar.blade.php-collapse';
  var Default = {
